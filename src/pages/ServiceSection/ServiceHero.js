...
function ServiceHero() {
  ...
  const fetchServiceHero = async () => {
    try {
      ...
      const response = await fetch('http://31.97.228.17:5101/api/servicepage/service-hero', {
  ...
  const addPoint = async () => {
    ...
    try {
      const token = sessionStorage.getItem('token');
      const response = await fetch('http://31.97.228.17:5101/api/servicepage/service-hero/points', {
        method: 'POST',
  ...
  const deletePoint = async (index) => {
    try {
      const token = sessionStorage.getItem('token');
      await fetch(`http://31.97.228.17:5101/api/servicepage/service-hero/points/${index}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      fetchServiceHero();
  ...
  const handleDelete = async () => {
    ...
    try {
      const token = sessionStorage.getItem('token');
      await fetch('http://31.97.228.17:5101/api/servicepage/service-hero', {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
